...
//! LICENSE: This localization file is part of JPEGView <https://github.com/qusielle/vibe-jpegview-linux> and distributed under the same license.  See <https://github.com/qusielle/vibe-jpegview-linux> for more info.
